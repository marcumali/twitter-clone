...
const Profile: NextPage = () => {
  ...
  return (
    <LayoutMain>
      ...
      <div className="d-flex align-items-end justify-content-between px-3 mt-n55px">
        <div className="border-3-solid-white rounded-circle">
          <Avatar sm={60} md={100} />
        </div>
        <div>
          <ModalButton modalTitle="Edit Profile" btnChildren={<Button variant="outline-light">Edit Profile</Button>}>
